...
//
// //userning 1chi harfini olish
//
// console.log(user[0]);
//
// //user katta harflarda yozish methodi uchun toUppercase() ishlatiladi
//
//
//
// console.log(user.toUpperCase());
//
// //metod bizga yangi qiymat beradi
//
// const upperCaseUser = user.toUpperCase();
//
// console.log(upperCaseUser);
//
// //toLowercase() metodi hammasini kichkina yozuvga ozgartiradi
//
...
//
// console.log(parseFloat(marginLeft)); // bu joyda esa 12.5 soni chiqadi
